...
def select_in_db():
    dbcursor.execute("SELECT * FROM database_name WHERE TEXT LIKE 'pattern_to_search_for' AND FILE_NAME='" + sys.argv[1] + "';") #Busca según el argumento que tu le des en la ejecución.
...
if select_in_db() is None:
    print ("Error en el envío FTP. Por favor vuelva a intentarlo.")
else:
    pass
